...
export const metadata: Metadata = {
  title: 'Chenghao “Tommy” Jiang — Independent Researcher & Developer',
  description: 'Chenghao “Tommy” Jiang is an independent researcher and developer actively seeking new research roles in 3D computer vision, SLAM, and generative models.',
  icons: {
    icon: [
